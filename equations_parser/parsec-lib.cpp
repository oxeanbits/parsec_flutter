...
Java_com_oxeanbits_parsec_1android_Parsec_nativeEval(JNIEnv *env, jobject /* this */, jstring input) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_oxeanbits_parsec_1android_Parsec_nativeEvalJson(JNIEnv *env, jobject /* this */, jstring input) {
    const char *inputChars = env->GetStringUTFChars(input, NULL);
    return CalcJson(env, string(inputChars));
}

extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_oxeanbits_parsec_1android_Parsec_nativeEvalJsonArray(JNIEnv *env, jobject /* this */, jobjectArray input) {
